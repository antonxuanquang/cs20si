! function(e) {
    ...
    var r = t(12),
        ...
        u = function() {
            function e() {
                o()(this, e), this.workplace = document, this.body = document.body, this.queryInput = this.workplace.getElementById(e.QUERY_INPUT_ID), this.queryResult = this.workplace.getElementById(e.QUERY_RESULT_ID), this.queryResultWrapper = this.workplace.getElementById(e.QUERY_RESULT_WRAPPER_ID), this.mic = this.workplace.getElementById(e.QUERY_MIC_ID), this.preloader = this.workplace.getElementById(e.PRELOADER_ID), this.agentAvatar = this.workplace.getElementById(e.ID_AGENT_AVATAR_IMAGE)
            }
            return a()(e, [{
                key: "checkAvatar",
                value: function() {
                ...
                value: function() {
                    ...
                    return n.className = e.CLASS_SERVER_RESPONSE, n.innerHTML = e.DEFAULT_EMPTY_NODE_CONTENT, this.queryResult.appendChild(n), n
                }
            }, {
                key: "setErrorOnNode",
                value: function(n, t) {
                ...
                value: function(e, n) {
                    return n.innerHTML = e, this
                }
            }, {
                key: "scrollResultWrapperNodeToBottom",
                value: function() {
                    return this.queryResultWrapper.scrollTop = this.queryResultWrapper.scrollHeight, this
                }
            }, {
                key: "handleStartRecognition",
                value: function() {
                    return this.mic.className += " " + e.CLASS_MIC_ACTIVE, this
                }
            }, {
                key: "handleStopRecognition",
                value: function() {
                    var n = new RegExp("(?:^|\\s)" + e.CLASS_MIC_ACTIVE + "(?!\\S)", "gi");
                    return this.mic.className = this.mic.className.replace(n, ""), this
                }
            }, {
    ...
    n.a = u, u.QUERY_INPUT_ID = "query", u.QUERY_RESULT_ID = "result", u.QUERY_RESULT_WRAPPER_ID = "resultWrapper", u.QUERY_MIC_ID = "mic", u.PRELOADER_ID = "preloader", u.CLASS_USER_REQUEST = "user-request", u.CLASS_SERVER_RESPONSE = "server-response", u.CLASS_SERVER_RESPONSE_ERROR = "server-response-error", u.ID_AGENT_AVATAR_IMAGE = "agent-avatar", u.CLASS_MIC_ACTIVE = "active", u.DEFAULT_EMPTY_NODE_CONTENT = "...", u.DEFAULT_AVATAR_SRC = "/api-client/assets/img/logo-short.png"
}, function(e, n, t) {
    var r = t(8),
        o = t(0)("toStringTag"),
    ...
    var r = t(12),
        ...
        c = function() {
            function e(n) {
                var t = this;
                o()(this, e), this.domHelper = n, this.handleMicClick = function() {
                    ...
                    if ("" !== n.replace(/\s/g, "")) {
                        ...
                        s.a.get(e.API_URL, t.buildPayLoad(t.domHelper.getInputValue())).then(o.success, o.error), t.domHelper.setInputValue("").scrollResultWrapperNodeToBottom()
                    }
            ...
            return a()(e, [{
                ...
                value: function(n, t) {
                    ...
                    if (!(o.status && o.status.code && o.status.code === e.HTTP_STATUS.OK && o.result && o.result)) return this.handleError(o, t);
                ...
                value: function(n) {
                    ...
                    return t || (t = e.DEFAULT_NO_ANSWER), u.a.escapeString(t)
                }
            }, {
                key: "handleError",
                value: function(n, t) {
    ...
    n.a = c, c.API_URL = location.href + "/demoQuery", c.DEFAULT_ERROR = "Sorry, it seemed like there was an error during request.", c.DEFAULT_NO_ANSWER = "[empty response]", c.HTTP_STATUS = {
        OK: 200
    }, c.KEY_CODES = {
        ENTER: 13
    }
